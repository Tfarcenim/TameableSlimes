...
public class SlimeFollowOwnerGoal extends Goal {
    ...
    private final TamableSlime tamable;
    ...
    public SlimeFollowOwnerGoal(TamableSlime pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
