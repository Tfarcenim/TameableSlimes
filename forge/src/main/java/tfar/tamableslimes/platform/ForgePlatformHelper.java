package tfar.tamableslimes.platform;
...
import tfar.tamableslimes.TameableSlimesForge;
import tfar.tamableslimes.platform.services.IPlatformHelper;
        ...
        for (Field field : clazz.getFields()) {
            ...
            try {
                ...
                if (filter.isInstance(o)) {
                    list.add(Pair.of(new ResourceLocation(TamableSlimes.MOD_ID,field.getName().toLowerCase(Locale.ROOT)),() -> o));
                }
